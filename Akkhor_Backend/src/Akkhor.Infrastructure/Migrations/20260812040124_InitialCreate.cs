        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPublished = table.Column<bool>(type: "boolean", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Assignments_ClassSections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentEnrollments_ClassSections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "ClassSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_ClassId_CourseId_SubjectId",
                table: "Assignments",
                columns: new[] { "ClassId", "CourseId", "SubjectId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherAssignments_TeacherId_AcademicYearId_ClassId_Section~",
                table: "TeacherAssignments",
                columns: new[] { "TeacherId", "AcademicYearId", "ClassId", "SectionId", "CourseId", "SubjectId" },
                unique: true);
